...
define( 'HOUZEZ_THEME_VERSION', '2.6.1' );
...
if ( ! function_exists( 'houzez_setup' ) ) {
	...
	function houzez_setup() {
		...
		add_image_size( 'houzez-gallery', 1170, 785, false);	
		add_image_size( 'houzez-item-image-1', 592, 444, false );
		add_image_size( 'houzez-item-image-4', 758, 564, false );
		add_image_size( 'houzez-item-image-6', 584, 438, false );
		add_image_size( 'houzez-variable-gallery', 0, 600, false );
		add_image_size( 'houzez-map-info', 120, 90, false );
...
if( ! function_exists('houzez_save_custom_options_for_cron') ) {
    function houzez_save_custom_options_for_cron() {
        ...
        $glc_beds = houzez_option('glc_beds', 'Beds');
        $glc_bed = houzez_option('glc_bed', 'Bed');
        $glc_baths = houzez_option('glc_baths', 'Baths');
        $glc_bath = houzez_option('glc_bath', 'Bath');

        $size_label = houzez_option('spl_prop_size');
		$land_label = houzez_option('spl_land');
		$rooms_label = houzez_option('glc_rooms', 'Rooms');
		$room_label = houzez_option('glc_room', 'Room');
		$bedrooms_label = houzez_option('glc_bedrooms', 'Bedrooms');
		$bedroom_label = houzez_option('glc_bedroom', 'Bedroom');
		...
		$featured_listing_expire = houzez_option('featured_listing_expire');

        $match_submission_message = houzez_option('houzez_matching_submissions');
        $match_submission_subject = houzez_option('houzez_subject_matching_submissions');

        $membership_cancelled = houzez_option('houzez_membership_cancelled');
        $subject_membership_cancelled = houzez_option('houzez_subject_membership_cancelled');
        ...
        update_option('houzez_social_1_icon', $social_1_icon);
        update_option('houzez_social_1_link', $social_1_link);
        update_option('houzez_social_2_icon', $social_2_icon);
        update_option('houzez_social_2_link', $social_2_link);
        update_option('houzez_social_3_icon', $social_3_icon);
        update_option('houzez_social_3_link', $social_3_link);
        update_option('houzez_social_4_icon', $social_4_icon);
        update_option('houzez_social_4_link', $social_4_link);


        update_option('houzez_enable_paid_submission', $enable_paid_submission);
        update_option('houzez_per_listing_expire_unlimited', $per_listing_expire_unlimited);
        update_option('houzez_per_listing_expire', $per_listing_expire);
        update_option('houzez_featured_listing_expire', $featured_listing_expire);
        
        update_option('houzez_enable_html_emails', $enable_html_emails);
        update_option('houzez_enable_email_header', $enable_email_header);
        update_option('houzez_enable_email_footer', $enable_email_footer);


        update_option('houzez_email_footer_content', $email_footer_content);
        update_option('houzez_email_head_logo', $email_head_logo);
        update_option('houzez_email_head_bg_color', $email_head_bg_color);
        update_option('houzez_email_foot_bg_color', $email_foot_bg_color);
        update_option('houzez_insights_removal', $insights_removal);
        update_option('houzez_custom_days', $custom_days);

        update_option('houzez_glc_beds', $glc_beds);
        update_option('houzez_glc_bed', $glc_bed);
        update_option('houzez_glc_baths', $glc_baths);
        update_option('houzez_glc_bath', $glc_bath);
        update_option('houzez_currency_symbol', $currency_symbol);

        update_option('houzez_match_submission_subject', $match_submission_subject);
        update_option('houzez_match_submission_message', $match_submission_message);

        update_option('houzez_subject_membership_cancelled', $subject_membership_cancelled);
        update_option('houzez_membership_cancelled', $membership_cancelled);
    }
}